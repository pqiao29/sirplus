...
models (ICMs)](https://www.ncbi.nlm.nih.gov/pubmed/29731699) to simulate contagious disease spread using compartments not 
available in standard SIR model in the [EpiModel package](http://www.epimodel.org/). This method and most of the code was 
...
Each one of  **inf.i**, **inf.e** and **inf.q** are controled by two parameters: <br>
